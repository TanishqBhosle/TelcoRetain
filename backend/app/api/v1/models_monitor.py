...
async def list_models(service: ModelService = Depends(get_model_service), current_user=Depends(get_current_user)):
...
async def activate_model(id: uuid.UUID, service: ModelService = Depends(get_model_service), current_user=Depends(get_current_user)):
...
async def model_performance(id: uuid.UUID, service: ModelService = Depends(get_model_service), current_user=Depends(get_current_user)):
