...
async def dashboard_kpis(service: AnalyticsService = Depends(get_analytics_service), current_user=Depends(get_current_user)):
...
async def churn_trends(service: AnalyticsService = Depends(get_analytics_service), current_user=Depends(get_current_user)):
...
async def revenue_risk(service: AnalyticsService = Depends(get_analytics_service), current_user=Depends(get_current_user)):
...
async def regional_analysis(service: AnalyticsService = Depends(get_analytics_service), current_user=Depends(get_current_user)):
...
async def operator_analysis(service: AnalyticsService = Depends(get_analytics_service), current_user=Depends(get_current_user)):
