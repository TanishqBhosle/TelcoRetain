            ...
            <div style={{ padding: "12px 0" }}>
              {explanation.features
                ...
                .map((feature) => {
                  ...
                  return (
                    <div key={feature.feature_name} style={{ display: "grid", gridTemplateColumns: "140px 1fr 80px", gap: 10, alignItems: "center", padding: "8px 0", borderBottom: "1px solid #e7eee9" }}>
          ...
          {explanation && explanation.reasons.length > 0 ? (
            <div style={{ padding: "12px 0", display: "grid", gap: 10 }}>
              {explanation.reasons.map((reason, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, padding: "10px 12px", background: "#f8faf9", borderRadius: 8, border: "1px solid #e7eee9" }}>
